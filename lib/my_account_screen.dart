...
class _MyAccountScreenState extends State<MyAccountScreen> {
  ...
  Future<void> _showEditNameDialog() async {
    TextEditingController nameController = TextEditingController(
      text: _currentDisplayName.isEmpty
          ? AppLocalizations.of(context)!.defaultPlayerName
          : _currentDisplayName,
    );
    bool isSaving =
        false; // Tracks the loading state during the database update
        ...
        return StatefulBuilder(
          builder: (context, setDialogState) {
            return AlertDialog(
              ...
              title: Text(
                AppLocalizations.of(context)!.editProfileName,
                    ...
                    : TextButton(
                        onPressed: () async {
                          ...
                          if (newName.isNotEmpty &&
                              newName != _currentDisplayName) {
                            setDialogState(
                              () => isSaving = true,
                            ); // Trigger loading animation

                            // 🚀 Update the name across Auth, Users, and Leaderboard collections
                            String result = await AuthService().syncUserName(
                              newName,
                            );
                  ...
                  Center(
                    child: Container(
                      ...
                      child: widget.user == null
                          ...
                          // IF THERE IS A USER, FETCH AVATAR FROM FIRESTORE
                          : FutureBuilder<DocumentSnapshot>(
                              ...
                              builder: (context, snapshot) {
                                if (snapshot.hasData && snapshot.data!.exists) {
                                  ...
                                  int avatarIndex = data['avatarIndex'] ?? 0;
                                  // Draw the selected avatar on screen
                                  return AvatarHelper.buildAvatar(
                                    avatarIndex,
                                    radius: 60,
                                  );
                                }
                                // While loading or if error occurs, show an empty avatar
                      ...
                      children: [
                        _buildAccountInfoRow(
                          ...
                          widget.user != null
                              ...
                              : AppLocalizations.of(context)!.guestAccount,
                          widget.user != null ? AppColors.success : Colors.grey,
                        ),
                        const Divider(
                          color: AppColors.surfaceLight,
                          height: 32,
